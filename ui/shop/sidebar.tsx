...
export default function Sidebar() {
  ...
  return (
    ...
    <div className="fixed top-0 z-20 flex w-full flex-col border-b border-gray-950 bg-gray-800 lg:bottom-0 lg:z-auto lg:w-72 lg:border-b-0 lg:border-r lg:border-gray-800">
