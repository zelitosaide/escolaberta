...
import EscolAbertaBlackWhiteLogo from "./escolaberta-black-white-logo";
...
export default function Sidebar() {
  ...
  return (
    ...
    <div className="fixed top-0 z-20 flex w-full flex-col border-b border-gray-800 bg-slate-950 lg:bottom-0 lg:z-auto lg:w-72 lg:border-b-0 lg:border-r lg:border-gray-800">
      <div className="flex h-14 items-center px-4 py-4 lg:h-auto">
        <div className="group flex w-full items-center gap-x-2.5">
          <div className="h-7 w-7 rounded-full border border-white/30 flex items-center justify-center">
            <Link href="/">
              <EscolAbertaBlackWhiteLogo />
            </Link>
          </div>

          <h3 className="font-semibold tracking-wide text-gray-400">
            <Link href="/">EscolAberta</Link>{" "}/{" "}Shop
          </h3>
        </div>
      </div>
      <button
